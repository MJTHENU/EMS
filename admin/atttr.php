...
$sqlNames = "SELECT emp_id, first_name FROM employee WHERE type = 3 AND status != 'inactive'";
...
<body>
    ...
    <div class="container-fluid">
        <h2 class="h2">Trianee Attendance</h2>
        <div class="contain">
            <div class="input-container">
                <input list="employee-options" id="employee-input" placeholder="Search Trianee ID / Name">
...
foreach ($employees as $emp_id => $emp_name): ?>
    <tr>
        <td><?php echo $counter++; ?></td> <!-- Increment the counter after printing it -->
