...
// Query to fetch employee details for the table with type = 2
$sql = "SELECT 
            employee.type, 
            employee.emp_id, 
            employee.img, 
        ...
        WHERE employee.type = 2"; // Filter by type = 2
...
$sql_employee_options = "SELECT emp_id, first_name FROM employee WHERE type = 2";
